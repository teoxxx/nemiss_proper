...
theta1=((2.0*pipi/140000.0)*g_time+theta0);
...
phi1=0.0;
/*250123 SOS scrange blobby-jets hmm messes up accr disk. No, 
just place fpoint elsewhere within rlos!!! OR create a tilted ac.disk wind construct. Noah, just move the fpoint in rlos, easiest. */
phi1=0.00;/*0.96*/
...
/*250123 short blobs med intervals NONONO! at neutrino scale, timestep is 10^3 times smaller than radio scale. So cont. jet here, as part (beginning) of a radio-scale blob*/
tinterval=100;
tblob=99;
/*here we set the integer part of the time*/
tinteger=(int)(g_time);
