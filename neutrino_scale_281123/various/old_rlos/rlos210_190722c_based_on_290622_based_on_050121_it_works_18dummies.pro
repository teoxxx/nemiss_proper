...
if(synchrotron_emissivity_switch eq 1.0) then(  kabs_4d=kappa_value_power_law*(c6_pachz(gammac))*rho_4d*( ( bfield_4d*sinlosb_4d )^( (gammac+2.)/2.) )*((nobs/2.)/c1_pachz)^((-4.-gammac)/2.)   )
;;kabs=cp6(0.)*ndens*(bfield*sin(theta))^((gammac+2.)/2.)*((ng/2.)/cp1(0.))^(-(gammac+4.)/2.)
...
if(synchrotron_emissivity_switch eq 1.0) then(  emiss_4d=(c5_pachz(gammac))*rho_4d*( ( bfield_4d*sinlosb_4d )^( (gammac+1.)/2.) )*((nobs/2.)/c1_pachz)^((1.-gammac)/2.)*(dopplerfactor_4d*dopplerfactor_4d)   )
...
global_absorption,Temp_4d,PRS_4d,RHO_4d,dopplerfactordivisor,xfrac,gaunt,ng,emiss,resultvectorfinal,kabs_4d,kabs2_4d,NLONG, synchrotron_emissivity_switch, alphaindex_external, v_4d, sinlosb_4d, bx1_4d, bx2_4d, bx3_4d, bfield_4d, nobs, c1_pachz, c2_pachz, c3_pachz, c4_pachz, dopplerfactor_4d, kappa_value_power_law
