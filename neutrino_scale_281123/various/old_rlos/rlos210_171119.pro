...
if (pload_float_factor eq 1.0) then pload, 21,shrink =sfactor_external, dir=datapath,/float else pload, 1,shrink =sfactor_external, dir=datapath,/double
...
pro emiss_global_calc, dopplerchoice,emiss_4d,rho_4d,dopplerfactor_4d,alphaindex,freqfactor,spectrum_direct_switch,jet_spectrum_built_in_function_test_unity_at_108,debug_spectra_switch,emiss_4d_implied,emiss_4d_direct
...
for zindigo=1.0,nz1+6 do begin
 for yindigo=1.0,ny1+6 do begin
  for xindigo=1.0,nx_1+6 do begin
      xcoord(xindigo,yindigo,zindigo)=xindigo
      ycoord(xindigo,yindigo,zindigo)=yindigo
      zcoord(xindigo,yindigo,zindigo)=zindigo
  endfor
...
;210819 Indeed!
emiss_global_calc, dopplerchoice,emiss_4d,rho_4d,dopplerfactor_4d,alphaindex,freqfactor,spectrum_direct_switch,jet_spectrum_built_in_function_test_unity_at_108,debug_spectra_switch,emiss_4d_implied,emiss_4d_direct
